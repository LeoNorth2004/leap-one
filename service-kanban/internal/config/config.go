...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("database.db_name", "kanban_db")
	...
	v.SetDefault("jwt.secret", "leap-one-kanban-secret")
	v.SetDefault("jwt.expire_time", 24*time.Hour)
	v.SetDefault("jwt.issuer", "leap-one-kanban")
}
