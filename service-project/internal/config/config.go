...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("database.db_name", "project_db")
	...
	v.SetDefault("jwt.secret", "leap-one-project-secret")
	v.SetDefault("jwt.expire_time", 24*time.Hour)
	v.SetDefault("jwt.issuer", "leap-one-project")
}
