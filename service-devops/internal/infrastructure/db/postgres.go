...
import (
	...
	"leap-one/service-devops/internal/config"
...
func InitPostgreSQL(cfg *config.Config, logger *zap.Logger) (*gorm.DB, error) {
	...
	logger.Info("PostgreSQL连接初始化成�?, zap.String("host", cfg.Database.Host), zap.Int("port", cfg.Database.Port))
	return db, nil
}
func AutoMigrate(db *gorm.DB) error {
	return db.AutoMigrate(&entity.Repository{}, &entity.Pipeline{}, &entity.PipelineRun{}, &entity.PipelineJob{}, &entity.Artifact{}, &entity.Deployment{}, &entity.EnvVar{})
}
