...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("database.db_name", "document_db")
	...
	v.SetDefault("jwt.secret", "leap-one-document-secret")
	v.SetDefault("jwt.expire_time", 24*time.Hour)
	v.SetDefault("jwt.issuer", "leap-one-document")
}
